...
export function buildSnapshotStoragePlan(currentTime = new Date()) {
  ...
  return {
    ...
    dailyCsvKey: `history/daily/${isoDate}/latest-fuelprices.csv`,
    dailyManifestKey: `history/daily/${isoDate}/manifest.json`,
    versionedCsvKey: `history/runs/${year}/${month}/${safeTimestamp}/latest-fuelprices.csv`,
    versionedManifestKey: `history/runs/${year}/${month}/${safeTimestamp}/manifest.json`,
  };
}
